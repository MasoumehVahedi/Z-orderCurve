...
class BalancedIntervalTree:
    ...
    def build_tree(self, intervals):
        ...
        points = [point for interval, _ in intervals for point in (interval.low, interval.high)]
        ...
        for interval, mbr in intervals:
            if interval.high < median:
                left_intervals.append((interval, mbr))
            elif interval.low > median:
                right_intervals.append((interval, mbr))
            else:
                overlapping_intervals.append((interval, mbr))
